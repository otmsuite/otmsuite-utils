            ...
            setTimeout => # wait for the DOM
                ...
                @control =
                    ...
                    setSelection: (e, alpha=null, offset=null) ->
                        ...
                        @selection.alpha = (Math.round _alpha * 255)
                        ...
                        # Or set a default red
                          ...
                          @selection.color = colorPicker.SmartColor.RGBAArray [255, 0, 0, @selection.alpha]
                ...
                colorPicker.onInputColor (smartColor) =>
                    alpha = smartColor.getAlpha()
                    alpha = alpha/255
                    @control.setSelection null, alpha
