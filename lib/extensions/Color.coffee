    ...
    # -------------------------------------
        ...
        # ---------------------------
            setTimeout =>
                ...
                setColor = (smartColor) =>
                    _preferredFormat = atom.config.get 'otmsuite-utils.preferredFormat'
                    _format = _formatFormat or _inputColor?.format or _preferredFormat or 'RGB'

                    # TODO: This is very fragile
                    _function = if smartColor.getAlpha() < 255
                    ...
                    if _inputColor and atom.config.get 'otmsuite-utils.automaticReplace'
